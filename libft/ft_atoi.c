...
/*   Updated: 2022/09/25 06:36:20 by jalwahei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_atoi(const char *str)
{
	...
	{
		if (res >= LLONG_MIN / 10 || (res <= LLONG_MIN && res > LLONG_MIN / 10)
...
// { 
// 	char *test = "6@43651";
//     printf("OUR atoi     %llu \n", (unsigned long long)ft_atoi(test));
//     printf("THEIR atoi   %llu \n", (unsigned long long)atoi(test));
//     return 0;
// }
